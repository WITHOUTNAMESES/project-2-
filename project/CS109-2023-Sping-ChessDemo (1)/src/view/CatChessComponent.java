...
public class CatChessComponent extends JComponent {
    ...
    public CatChessComponent(PlayerColor owner, int size) {
        this.filename = "cat.wav";
        this.owner = owner;
        this.selected = false;
        setSize(size/2, size/2);
        setLocation(0,0);
        setVisible(true);
        image1 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家1\\IMG_6603(20230525-101803).PNG").getImage());
        image2 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家2\\cat2.png").getImage());
    }
