...
public class ElephantChessComponent extends JComponent {
    ...
    private ChessPiece Elephant;

    public ElephantChessComponent(PlayerColor owner, int size) {
        this.filename = "ele.wav";
        this.owner = owner;
        this.selected = false;
        setSize(size/2, size/2);
        setLocation(0,0);
        setVisible(true);
        image1 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家1\\IMG_6609(20230525-153906).PNG").getImage());
        image2 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家2\\ele2.png").getImage());
