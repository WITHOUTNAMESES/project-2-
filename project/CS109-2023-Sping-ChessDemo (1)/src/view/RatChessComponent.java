...
public class RatChessComponent extends JComponent {
    ...
    public RatChessComponent(PlayerColor owner, int size) {
        this.filename = "rat.wav";
        this.owner = owner;
        this.selected = false;
        setSize(size/2, size/2);
        setLocation(0,0);
        setVisible(true);
        image1 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家1\\IMG_6600(20230525-101831).PNG").getImage());
        image2 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家2\\rat2.png").getImage());
