...
public class LeopardChessComponent extends JComponent {
    ...
    public LeopardChessComponent(PlayerColor owner, int size) {
        this.filename = "leo.wav";
        this.owner = owner;
        this.selected = false;
        setSize(size/2, size/2);
        setLocation(0,0);
        setVisible(true);
        image1 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家1\\leo.PNG").getImage());
        image2 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家2\\leo2.png").getImage());
    }
