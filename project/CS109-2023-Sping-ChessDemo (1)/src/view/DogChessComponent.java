...
public class DogChessComponent extends JComponent {
    ...
    public DogChessComponent(PlayerColor owner, int size) {
        ...
        setLocation(0,0);
        setVisible(true);
        image1 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家1\\dog.png").getImage());
        image2 = (new ImageIcon("C:\\Users\\名称黑洞\\Desktop\\project（2）\\image源\\玩家2\\dog2.png").getImage());
    }
